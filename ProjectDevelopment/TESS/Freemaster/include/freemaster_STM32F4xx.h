...
#define FMSTR_USART_SR_OFFSET  (FMSTR_U32)0x0000001C
#define FMSTR_USART_ICR_OFFSET (FMSTR_U32)0x0000001C /*clear status register*/
#define FMSTR_USART_CR1_OFFSET (FMSTR_U32)0x00000000
#define FMSTR_USART_CR2_OFFSET (FMSTR_U32)0x00000004
#define FMSTR_USART_CR3_OFFSET (FMSTR_U32)0x00000008
#define FMSTR_USART_DR_OFFSET  (FMSTR_U32)0x00000024
#define FMSTR_USART_TDR_OFFSET (FMSTR_U32)0x00000028  /*STM32G4 has 2 registers for send and receive*/
...
/* Tranmsit character */
#define FMSTR_SCI_PUTCHAR(ch) FMSTR_SETREG8(FMSTR_SCI_BASE, FMSTR_USART_TDR_OFFSET, ch)

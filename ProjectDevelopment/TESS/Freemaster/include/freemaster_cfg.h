...
#define FMSTR_SCI_BASE         0x40004800U /* base address of UART register space on STM32F4xx  */
...
#define FMSTR_REC_TIMEBASE     FMSTR_REC_BASE_MICROSEC(500) /* 0 = "unknown" *//*100- 100us*/
